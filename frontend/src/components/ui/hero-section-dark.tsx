...
const HeroSectionDark = React.forwardRef<HTMLDivElement, HeroSectionDarkProps>(
  (
    ...
    const expertCardsRef = React.useRef<HTMLDivElement>(null);

    const scrollToExpertCards = () => {
      expertCardsRef.current?.scrollIntoView({
        behavior: "smooth",
        block: "start",
      });
    };
      ...
      >
        ...
        <section className="relative max-w-full mx-auto z-1">
          ...
          <div className="max-w-screen-xl z-10 mx-auto px-4 py-28 gap-12 md:px-8">
            ...
            >
              <motion.div variants={itemVariants} className="relative -top-2">
