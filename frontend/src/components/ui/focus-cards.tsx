    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-0">
          {/* Background color that matches your loading state */}
          <div className={`absolute inset-0 bg-gray-200 dark:bg-neutral-800 transition-opacity duration-300 ${imageLoaded ? 'opacity-0' : 'opacity-100'}`} />
